  ...
  app.DetailsView = Backbone.View.extend({
    ...
    syncUp: function() {
      this.model.set({
        ...
        employeeId: app.mainView.model.get('employeeId'),
        ...
        credits: app.mainView.model.get('credits'),
        dailyLimit: app.mainView.model.get('dailyLimit'),
    ...
    update: function() {
      this.model.save({
        ...
        employeeId: this.$el.find('[name="employeeId"]').val(),
        ...
        credits: this.$el.find('[name="credits"]').val(),
        dailyLimit: this.$el.find('[name="dailyLimit"]').val(),
